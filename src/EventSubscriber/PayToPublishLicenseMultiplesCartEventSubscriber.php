...
/**
 * Decorates the Commerce License cart EventSubscriber, overriding the 
 * quantity restriction for pay_to_publish license order item types.
 *
 ...
 */
class PayToPublishLicenseMultiplesCartEventSubscriber implements EventSubscriberInterface
{
    ...
    public function onCartEntityAdd(CartEntityAddEvent $event)
    {
        ...
        // Or if the order item is not a pay_to_publish order type.
